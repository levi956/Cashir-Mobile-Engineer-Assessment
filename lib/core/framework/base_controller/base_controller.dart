...
import '../stream_state/stream_state.dart';

enum TriggerType { value, reset }
...
class BaseController<SinkType, StreamType> {
  ...
  bool _triggerFirstTime = true;

  void triggerOnce(SinkType model, {bool startsWithLoading = true}) {
    if (_triggerFirstTime) {
      trigger(model, startsWithLoading: startsWithLoading);
      _triggerFirstTime = false;
      return;
    }
    trigger(model, startsWithLoading: false);
  }
